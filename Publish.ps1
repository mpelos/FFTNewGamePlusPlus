...
param (
    ...
    ## => User Config <= ##
    $ProjectPath = "src/fftivc.battles.ngplus/fftivc.battles.ngplus.csproj",
    $PackageName = "fftivc.battles.ngplus",
    ...
    $MetadataFileName = "fftivc.battles.ngplus.ReleaseMetadata.json",
    ...
    $GitHubRepoName = "FFTNewGamePlusPlus", # Name of the GitHub repo where the mod is contained
    ...
    $NuGetPackageId = "fftivc.battles.ngplus",
