...
| `054` | 49 | Monastery Vaults 4th Floor | ENDGAME 1/5; 2 Eagrose Knight Martial Artists + Eagrose Knight Samurai + 2 South Wall Monks + South Wall Ninja | v3 docs-only imported-build opener; Loffrey exits; no reward | 📝 Ready |
