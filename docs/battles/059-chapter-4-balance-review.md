...
| 46 | Mullonde — Exterior | `051` | 6 (hidden roof **White Mage** + 2 Geomancer + 2 Orator + Summoner) | v3 docs-only; gender recast; band 100-102; Stoneshooter/Mana-Shield Orators; chain 1/3 | cathedral ext | ▃ moderate |
