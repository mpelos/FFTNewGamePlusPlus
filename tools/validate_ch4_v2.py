...
def run() -> int:
    ...
    # Endgame gauntlet opener: Loffrey exits by script; six imported Eagrose/South-Wall builds.
    e = 435
    active = [1, 2, 3, 4, 5, 6]
    ...
    check("435 active levels", roster(entd, e, active, 0x03) == [100, 100, 101, 101, 101, 102])
    check("435 active job buckets", roster(entd, e, active, 0x08) == [4, 4, 14, 4, 4, 15])
    check("435 active job levels", roster(entd, e, active, 0x09) == [8, 8, 8, 8, 8, 8])
    check("435 active secondaries", roster(entd, e, active, 0x0B) == [9, 9, 19, 0, 0, 9])
    check("435 Brave targets", roster(entd, e, active, 0x06) == [88, 86, 88, 88, 88, 90])
    check("435 Faith targets", roster(entd, e, active, 0x07) == [42, 44, 58, 38, 38, 35])
    for slot_no in (1, 2):
        check(f"435 s{slot_no} Eagrose Martial Knight kit",
              field16(entd, e, slot_no, 0x0C) == 442
              and field16(entd, e, slot_no, 0x0E) == 465
              and field16(entd, e, slot_no, 0x10) == 488
              and roster(entd, e, [slot_no], 0x12) == [154]
              ...
              and roster(entd, e, [slot_no], 0x15) == [30]
              and roster(entd, e, [slot_no], 0x16) == [139])
    check("435 s3 Eagrose Samurai Knight kit",
          field16(entd, e, 3, 0x0C) == 451
          and field16(entd, e, 3, 0x0E) == 476
          and field16(entd, e, 3, 0x10) == 488
          ...
          and roster(entd, e, [3], 0x16) == [255])
    for slot_no in (4, 5):
        check(f"435 s{slot_no} South Wall Monk kit",
              field16(entd, e, slot_no, 0x0C) == 442
              and field16(entd, e, slot_no, 0x0E) == 477
              and field16(entd, e, slot_no, 0x10) == 491
              and roster(entd, e, [slot_no], 0x12) == [170]
              and roster(entd, e, [slot_no], 0x13) == [195]
              and roster(entd, e, [slot_no], 0x14) == [218]
              and roster(entd, e, [slot_no], 0x15) == [255]
              and roster(entd, e, [slot_no], 0x16) == [255])
    check("435 South Wall Ninja replaces Archer",
          field16(entd, e, 6, 0x0C) == 442
          and field16(entd, e, 6, 0x0E) == 472
          and field16(entd, e, 6, 0x10) == 491
          ...
          and roster(entd, e, [6], 0x15) == [255]
          and roster(entd, e, [6], 0x16) == [255])
    check("435 positions preserved",
          [(field(entd, e, s, 0x19), field(entd, e, s, 0x1A)) for s in active]
          == [(1, 3), (4, 5), (4, 1), (7, 2), (9, 0), (12, 1)])
